...
var dX = Math.cos(secondsAngle) * R * 0.9;
var dY = - Math.sin(secondsAngle) * R * 0.9;

dX += R; dY += R;

var eX = Math.cos(minutesAngle) * R * 0.6;
var eY = - Math.sin(minutesAngle) * R * 0.6;

eX += R; eY += R;

var lX = Math.cos(hoursAngle) * R * 0.4;
var lY = - Math.sin(hoursAngle) * R * 0.4;

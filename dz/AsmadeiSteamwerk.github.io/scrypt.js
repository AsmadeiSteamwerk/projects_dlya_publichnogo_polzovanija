...
let dX = Math.cos(secondsAngle);
let dY = - Math.sin(secondsAngle);

let eX = Math.cos(minutesAngle);
let eY = - Math.sin(minutesAngle);

let lX = Math.cos(hoursAngle);
let lY = - Math.sin(hoursAngle);
